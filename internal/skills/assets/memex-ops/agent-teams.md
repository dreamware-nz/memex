...
| Fetch, turndown, HTML, markdown conversion, web | **Web/Fetch Architect** | memex_fetch_and_index, HTML→markdown, chunking, URL handling |
...
```
You are the {Platform/Domain} {Role} for memex.
...
## Tools Available
- Use memex MCP tools (memex_execute, memex_batch_execute) for large output
