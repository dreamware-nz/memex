---
name: memex-ops
description: Manage memex GitHub issues, PRs, releases, and marketing with parallel subagent army. Orchestrates 10-20 dynamic agents per task. Use when triaging issues, reviewing PRs, releasing versions, writing LinkedIn posts, announcing releases, fixing bugs, merging contributions, validating ENV vars, testing adapters, or syncing branches.
---
...
This is the project owner's standing operating directive for ALL memex-ops
...
> memex u da kullanarak en verimli sekilde LoC okudugundan emin ol.
...
> /memex-ops sana bircok Staff, Architect, Lead seviyede takimlar
...
3. **Anti-hallucination is the foundational law.** LLMs lie cheaply. Never
   ...
   Use `refs/` clones (platforms + plugin-examples) and `memex` MCP
...
11. **Skills toolkit is mandatory, not advisory:**
    ...
    - `/memex-ops` (this skill) — for every ops wave
...
4. **Cannot verify?** Comment on the issue asking for `memex-debug.sh` output and repro steps. Do NOT implement speculatively.
...
6. Use memex MCP tools inside agents for large output
...
npx skills add mksglu/memex --skill memex-ops

# Or install all memex skills
npx skills add mksglu/memex

# Or direct path
npx skills add https://github.com/mksglu/memex/tree/main/skills/memex-ops
```
